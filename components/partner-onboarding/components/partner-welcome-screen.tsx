...
export function PartnerWelcomeScreen({ onNext }: PartnerWelcomeScreenProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Feature cards — same grid as dashboard */}
      <div className="grid gap-4 sm:grid-cols-3">
        <div className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
          ...
          <h3 className="font-semibold text-gray-900">{t('welcomeGlobalNetworkTitle')}</h3>
          <p className="mt-1 text-sm text-gray-500 leading-relaxed">
            {t('welcomeGlobalNetworkDesc')}
          </p>
        </div>
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
          ...
          <h3 className="font-semibold text-gray-900">{t('welcomeRealImpactTitle')}</h3>
          <p className="mt-1 text-sm text-gray-500 leading-relaxed">
            {t('welcomeRealImpactDesc')}
          </p>
        </div>
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
          ...
          <h3 className="font-semibold text-gray-900">{t('welcomeSdgAlignedTitle')}</h3>
          <p className="mt-1 text-sm text-gray-500 leading-relaxed">
            {t('welcomeSdgAlignedDesc')}
          </p>
        </div>
      </div>
