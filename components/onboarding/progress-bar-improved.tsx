    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between mb-1">
        <div>
          ...
          <h2 className="text-lg font-medium text-[#8157D9] mt-1">{stepNames[currentStep]}</h2>
        </div>
      ...
      <div className="relative">
        ...
        {/* Filled track */}
        <div
          className="absolute top-1/2 left-0 h-0.5 -translate-y-1/2 bg-[#8157D9] transition-all duration-300 ease-in-out"
        ...
        <div className="relative flex justify-between">
          {stepNames.slice(0, totalSteps + 1).map((step, index) => {
            // Determine if this step is clickable (only previous steps)
                  ...
                  className={`
                    ...
                    ${
                      index < currentStep
                        ...
                        : index === currentStep
                          ? "bg-white border-[#8157D9] text-[#8157D9]"
