...
interface CrcAlignmentSectionProps {
  selectedCRCs: string[]
  activeCRCCategory: string
  onCRCToggle: (crcId: string) => void
  onCRCCategoryChange: (category: string) => void
}

export function CrcAlignmentSection({
  selectedCRCs,
  activeCRCCategory,
  onCRCToggle,
  onCRCCategoryChange,
}: CrcAlignmentSectionProps) {
  return (
    <Card>
      <CardHeader>
      ...
      <CardContent>
        <Tabs value={activeCRCCategory} onValueChange={onCRCCategoryChange}>
