...
export default function CoordinatorDashboardPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Welcome */}
      <div>
        <h1 className="text-3xl font-semibold text-gray-900">Hi, {firstName}</h1>
        <p className="mt-1 text-sm text-gray-600">
          Coordinator for {session?.organization ?? 'your organization'}
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <Card className="group transition-shadow hover:shadow-md">
          <CardContent className="p-6">
            ...
            <p className="mt-1 text-sm text-gray-500">
              View and manage the programs you coordinate.
            </p>
        ...
        <Card className="group transition-shadow hover:shadow-md">
          <CardContent className="p-6">
            ...
            <h3 className="text-lg font-semibold text-gray-900">Partner Content Hub</h3>
            <p className="mt-1 text-sm text-gray-500">
              Access resources and information from {session?.organization ?? 'your partner'}.
            </p>
            <Button variant="link" className="mt-3 h-auto p-0 text-purple-600" asChild>
