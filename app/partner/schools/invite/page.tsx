        ...
        <Card className="max-w-2xl w-full">
          <CardContent className="p-8">
            <div className="text-center mb-6">
              ...
              <h2 className="text-xl font-semibold text-gray-900 mb-2">Invitations Sent Successfully!</h2>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-4xl mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Invite Schools</h1>
                <p className="text-gray-600">Connect with schools to expand your partnership network</p>
              </div>
            </div>
      ...
      <div className="max-w-4xl mx-auto p-4 space-y-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center">
              ...
              Rights Schools Network (Denmark)
            </CardTitle>
            <CardDescription>
              Quick-add schools from the UNICEF Rights Schools network in Denmark
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Add Schools Manually</CardTitle>
            <CardDescription>
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Custom Invitation Message</FormLabel>
                      <FormControl>
                        <Textarea
