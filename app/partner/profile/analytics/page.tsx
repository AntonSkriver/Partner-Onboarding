      ...
      case 'projects': {
        ...
        return (
          <div className="space-y-10">
            ...
            {/* Project Cards */}
            <div>
              <h4 className="mb-6 text-base font-semibold text-gray-900">Projects by Impact</h4>
              <div className="space-y-6">
        ...
        >
          <Card className="overflow-hidden">
            <CardHeader>
              ...
              <CardDescription>
                Interactive map of {partnerRecord?.organizationName ?? 'partner'} programs. Click on a country to see detailed metrics.
              </CardDescription>
            </CardHeader>
            <CardContent>
