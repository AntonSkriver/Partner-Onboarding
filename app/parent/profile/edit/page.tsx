...
export default function ParentEditProfilePage() {
  ...
  // Load existing data - use UNICEF parent organization data
  useEffect(() => {
    // Load UNICEF World Organization data (parent organization)
    const defaultOrgName = 'UNICEF World Organization'
    const defaultMission = 'UNICEF works to secure every child\'s rights through global coordination, fundraising, education, and advocacy. We support country teams, schools, and partners to amplify impact for children worldwide.'
    ...
    const defaultSDGs = ['4', '5', '10', '13', '16', '17']
          ...
          <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Organization name and mission</CardDescription>
              </CardHeader>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="e.g., UNICEF World Organization" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea
                          placeholder="Describe your organization's mission and what you aim to achieve..."
                          className="min-h-[120px]"
                          {...field}
                        />
                      </FormControl>
                      <FormDescription>
                        Share what drives your organization and your goals
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="e.g., Global Partnerships Lead" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Select the areas your organization focuses on</CardDescription>
              </CardHeader>
              <CardContent>
                ...
                {selectedThematicAreas.length > 0 && (
                  <p className="text-sm text-gray-600 mt-3">
                    {selectedThematicAreas.length} area{selectedThematicAreas.length > 1 ? 's' : ''} selected
                  </p>
                )}
              </CardContent>
            </Card>
