      ...
      <div className="w-full lg:w-[45%] bg-white flex flex-col justify-center px-8 md:px-16 lg:px-20 py-12">
        <div className="max-w-md w-full mx-auto">
          ...
          <h1 className="text-3xl font-bold text-[#1a1a2e] mb-2">
            Log in to Class2Class
          </h1>
          <p className="text-gray-500 mb-8">
            Access your dashboard and manage your programs
          </p>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            <div className="space-y-2">
              <Label htmlFor="email" className="text-[#1a1a2e] font-medium">
                Username <span className="text-[#8157D9]">*</span>
              </Label>
              <Input
                id="email"
                type="text"
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                <Label htmlFor="password" className="text-[#1a1a2e] font-medium">
                  Password <span className="text-[#8157D9]">*</span>
                </Label>
      ...
      <div className="hidden lg:flex lg:w-[55%] bg-[#E0CCFF] relative overflow-hidden flex-col justify-center items-center p-12">
        ...
        <div className="relative z-10 max-w-lg">
          ...
          <p className="text-lg text-gray-700 mb-12">
            Join thousands of educators and organizations creating meaningful cross-cultural learning experiences.
          </p>
