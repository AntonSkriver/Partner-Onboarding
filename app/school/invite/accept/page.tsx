        ...
        <Card className="shadow-lg">
          <CardHeader>
            <CardTitle className="text-2xl text-gray-900">
              Set up {formState.schoolName}
            </CardTitle>
            <CardDescription>
              Accept your invitation, confirm details, and start with a clean school workspace.
            </CardDescription>
          </CardHeader>
              ...
              <div className="space-y-4">
                <div className="rounded-lg bg-blue-50 p-4 text-sm text-blue-900">
                  ...
                  <ul className="mt-1 space-y-1 text-blue-800">
                    ...
                    <li>• City/Country: {inviteMeta.city}, {inviteMeta.country}</li>
                  </ul>
                  <p className="mt-2 text-xs text-blue-700">
                    Your school starts blank: no teachers yet and only the invited program attached. You can add staff and join other programs after signing in.
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="contactName">Lead contact</Label>
                  <div className="relative">
              ...
              <div className="space-y-4">
                <div className="rounded-lg bg-green-50 p-4 text-sm text-green-900">
                  ...
                  <p className="mt-1 text-green-800">
                    Create a password to finish setting up your school workspace.
                  </p>
                </div>
