          ...
          <div className="w-full space-y-6">
            <div>
              <h1 className="text-3xl font-semibold text-gray-900">
                Sign up to Class2Class.org and become a Global Teacher
              </h1>
              <p className="mt-2 text-sm text-gray-600">Join as a teacher or student.</p>
            </div>
            ...
            <form className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="text-xs text-purple-700">Password Strength</div>
