...
export default function SchoolProfileEditPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>{t('schoolProfileTitle')}</CardTitle>
        ...
        <CardContent className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-gray-700">{t('contactEmailField')}</label>
              <Input
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          <div className="grid gap-4 md:grid-cols-3">
            <div className="space-y-2">
              <label className="text-sm font-medium text-gray-700">{t('numberOfStudents')}</label>
              <Input
                type="number"
                min="0"
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-gray-700">{t('numberOfTeachers')}</label>
              <Input
                type="number"
                min="0"
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-gray-700">{t('schoolType')}</label>
              <select
          ...
          <div className="space-y-3">
            <label className="text-sm font-medium text-gray-700">{t('gradeLevels')}</label>
            <p className="text-xs text-gray-500">{t('gradeLevelsDesc')}</p>
      ...
      <Card>
        ...
        <CardContent className="grid gap-4 md:grid-cols-2">
          <div className="space-y-2">
            <label className="text-sm font-medium text-gray-700">{t('mission')}</label>
            <Textarea
              rows={5}
          ...
          <div className="space-y-2">
            <label className="text-sm font-medium text-gray-700">{t('overviewField')}</label>
            <Textarea
              rows={5}
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>{t('mainContact')}</CardDescription>
        </CardHeader>
        <CardContent className="grid gap-4 md:grid-cols-3">
          <div className="space-y-2">
            <label className="text-sm font-medium text-gray-700">{t('principalLead')}</label>
            <Input
              value={formState.principalName}
              onChange={(e) => setFormState((prev) => ({ ...prev, principalName: e.target.value }))}
              placeholder={t('leadContactName')}
            />
          </div>
          <div className="space-y-2">
            <label className="text-sm font-medium text-gray-700">{tc('city')}</label>
            <Input
          ...
          <div className="space-y-2">
            <label className="text-sm font-medium text-gray-700">{tc('country')}</label>
            <Input
          ...
          {formState.sdgFocus.length > 0 && (
            <div className="mt-4">
              <p className="text-sm font-medium text-gray-700">
                {t('selectedSDGs', { count: formState.sdgFocus.length })}
              </p>
        ...
        <CardContent>
          ...
          {formState.childRightsFocus.length > 0 && (
            <div className="mt-6 space-y-2 border-t pt-4">
              <p className="text-sm font-medium text-gray-700">
                {t('selectedCRCs', { count: formState.childRightsFocus.length })}
              </p>
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex gap-2">
          <Button variant="outline" asChild>
            <Link href="/school/dashboard/overview">{tc('cancel')}</Link>
          </Button>
