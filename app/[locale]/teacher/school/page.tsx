    ...
    return (
      <Card className="border-dashed">
        <CardContent className="p-6">
          <h2 className="text-lg font-semibold text-gray-900">{t('noSchoolConnected')}</h2>
          <p className="mt-2 text-sm text-gray-600">
            {t('noSchoolConnectedDesc')}
          </p>
        </CardContent>
      </Card>
    )
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-3">
        ...
        <div>
          <h1 className="text-3xl font-semibold text-gray-900">{t('mySchool')}</h1>
        </div>
      </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h2 className="text-xl font-semibold text-gray-900">{t('colleagues')}</h2>
      ...
      {/* Resources Section */}
      <div className="space-y-4">
        <h2 className="text-xl font-semibold text-gray-900">{t('schoolResources')}</h2>
        <div className="grid gap-4 md:grid-cols-3">
          <Card className="border-purple-100 bg-gradient-to-br from-purple-50 to-white hover:shadow-md transition-shadow cursor-pointer">
            <CardContent className="p-5">
              ...
              <h3 className="mt-3 font-semibold text-gray-900">{t('teachingMaterials')}</h3>
              <p className="mt-1 text-sm text-gray-600">{t('teachingMaterialsDesc')}</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-purple-100 bg-gradient-to-br from-purple-50 to-white hover:shadow-md transition-shadow cursor-pointer">
            <CardContent className="p-5">
              ...
              <h3 className="mt-3 font-semibold text-gray-900">{t('schoolPolicies')}</h3>
              <p className="mt-1 text-sm text-gray-600">{t('schoolPoliciesDesc')}</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-purple-100 bg-gradient-to-br from-purple-50 to-white hover:shadow-md transition-shadow cursor-pointer">
            <CardContent className="p-5">
              ...
              <h3 className="mt-3 font-semibold text-gray-900">{t('trainingVideos')}</h3>
              <p className="mt-1 text-sm text-gray-600">{t('trainingVideosDesc')}</p>
            </CardContent>
          </Card>
        </div>
      </div>
      ...
      <AlertDialog open={connectDialogOpen} onOpenChange={setConnectDialogOpen}>
        <AlertDialogContent className="sm:max-w-md">
          <AlertDialogHeader className="text-center sm:text-center">
            ...
            <AlertDialogTitle>{t('connectWith', { name: teacherToConnect?.fullName ?? '' })}</AlertDialogTitle>
            <AlertDialogDescription>
              {t('connectWithDesc')}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter className="sm:justify-center gap-3">
            <AlertDialogCancel className="sm:w-32">{tc('cancel')}</AlertDialogCancel>
            <AlertDialogAction
