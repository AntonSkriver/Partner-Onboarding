...
const TAB_IDS = ['all', 'network', 'incoming', 'sent'] as const
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between">
        <div className="space-y-3">
          ...
          <h1 className="text-3xl font-semibold text-gray-900">{t('connections')}</h1>
        </div>
      ...
      <div className="space-y-4">
        <div className="grid gap-4 md:grid-cols-5">
          ...
          <div className="space-y-1.5">
            <label className="text-sm font-medium text-gray-700">{t('searchKeyword')}</label>
      ...
      <div>
        <h2 className="text-sm font-semibold text-gray-900">
          {activeTab === 'sent' ? t('pendingRequests', { count: filteredTeachers.length }) : t('allTeachersCount', { count: filteredTeachers.length })}
        </h2>
      </div>
          ...
          <CardContent className="p-12 text-center">
            {activeTab === 'sent' ? (
              <>
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-1">{t('noPendingRequests')}</h3>
                <p className="text-sm text-gray-500">Click the + button on a teacher card to send a connection request.</p>
              </>
            ) : (
              <>
                <Users className="h-12 w-12 text-gray-300 mx-auto mb-4" />
                <h3 className="text-lg font-medium text-gray-900 mb-1">{t('noTeachersFound')}</h3>
                <p className="text-sm text-gray-500">{t('noTeachersFoundDesc')}</p>
              </>
            )}
          </CardContent>
        </Card>
