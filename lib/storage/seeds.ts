...
const PROTOTYPE_SEED_VERSION = 12
...
const buildSeedInstitutions = (): PrototypeDatabase['institutions'] => [
  ...
  },
  {
    ...
    name: 'Aarhus Community School (inactive)',
    type: 'high_school',
    country: 'DK',
  ...
  },
  {
    ...
    name: 'Manchester Community School',
    type: 'secondary_school',
    country: 'UK',
    region: 'Greater Manchester',
    city: 'Manchester',
  ...
  {
    id: 'institution-copenhagen-global-campus',
    programId: 'program-child-world-2025',
    coordinatorId: 'coordinator-child-world-denmark',
    name: 'Copenhagen Global Campus',
    type: 'secondary_school',
    country: 'DK',
    region: 'Capital Region',
    city: 'Copenhagen',
    address: 'Global Learning Avenue 22',
    contactEmail: 'hello@cphglobal.dk',
    contactPhone: '+45 33 00 88 11',
    principalName: 'Louise Andersen',
    principalEmail: 'louise.andersen@cphglobal.dk',
    studentCount: 520,
    teacherCount: 36,
    educationLevels: ['secondary'],
    languages: ['da', 'en'],
    status: 'invited',
    invitedAt: '2025-03-18T08:40:00.000Z',
    createdAt: '2025-03-18T08:40:00.000Z',
...
const buildSeedTeachers = (): PrototypeDatabase['institutionTeachers'] => [
  ...
  },
  {
    ...
    programId: 'program-communities-2025',
    email: 'karin.albrectsen@aarhuscommunity.dk',
    firstName: 'Karin',
    lastName: 'Albrectsen',
  ...
  },
  {
    ...
    institutionId: 'institution-copenhagen-global-campus',
    programId: 'program-child-world-2025',
    email: 'jonas.madsen@cphglobal.dk',
    firstName: 'Jonas',
    lastName: 'Madsen',
  ...
  {
    id: 'teacher-orestad-jonas',
    institutionId: 'institution-orestad-gymnasium',
    programId: 'program-communities-2025',
    email: 'jonas.madsen@orestadgym.dk',
    firstName: 'Jonas',
    lastName: 'Madsen',
    subject: 'Global Citizenship',
    gradeLevel: 'Secondary',
    ...
    status: 'active',
    invitedAt: '2025-01-20T09:00:00.000Z',
    acceptedAt: '2025-01-20T14:30:00.000Z',
    createdAt: '2025-01-20T09:00:00.000Z',
...
const buildSeedActivities = (): PrototypeDatabase['activities'] => [
  ...
  },
  {
    ...
    actorName: 'Anne Holm',
    actorType: 'teacher',
    description: 'Aarhus Community School shared story-circle insights with partner classrooms in Manchester.',
