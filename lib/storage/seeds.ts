...
const buildSeedPrograms = (): PrototypeDatabase['programs'] => [
  ...
  {
    id: 'program-uk-digital-2025',
    partnerId: 'partner-unicef-england',
    displayTitle: 'UNICEF UK Digital Citizenship Exchange',
    name: 'Digital Citizenship Exchange',
    marketingTagline: 'UK-led digital citizenship projects co-created with partner schools abroad.',
    description:
      'Students co-design campaigns and peer guides on digital safety, media literacy, and online kindness, exchanging artifacts and feedback with partner classrooms.',
    projectTypes: ['cultural_exchange', 'create_solutions'],
    pedagogicalFramework: ['pbl', 'global_citizenship', 'design_thinking'],
    learningGoals:
      'Help learners practice safe, ethical, and inclusive digital behaviors while collaborating internationally on shared artifacts.',
    targetAgeRanges: ['12-14', '15-18'],
    countriesInScope: ['UK', 'IT', 'MX'],
    sdgFocus: [4, 10, 16],
    crcFocus: ['13', '16'],
    supportingPartnerId: 'partner-alm-brand',
    supportingPartnerRole: 'sponsor',
    ...
    endDate: '2025-12-20',
    programUrl: 'https://prototype.class2class.org/programs/digital-citizenship-exchange',
    brandColor: '#6B7CFF',
    logo: '/programs/digital-citizenship-exchange/logo.svg',
    heroImageUrl:
      'https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=800&h=480&fit=crop',
    status: 'active',
    isPublic: true,
...
const buildSeedProgramPartners = (): PrototypeDatabase['programPartners'] => [
  ...
  {
    id: 'program-partner-digital-uk-host',
    programId: 'program-uk-digital-2025',
    partnerId: 'partner-unicef-england',
    role: 'host',
    permissions: {
      canEditProgram: true,
    ...
    invitedBy: 'partner-user-unicef-coordination',
    invitedAt: '2025-03-15T09:05:00.000Z',
    status: 'accepted',
    acceptedAt: '2025-03-15T09:05:00.000Z',
    createdAt: '2025-03-15T09:05:00.000Z',
    updatedAt: '2025-03-25T11:00:00.000Z',
  },
  {
    id: 'program-partner-digital-uk-sponsor',
    programId: 'program-uk-digital-2025',
    partnerId: 'partner-alm-brand',
    role: 'sponsor',
    permissions: {
    ...
    invitedBy: 'partner-user-unicef-coordination',
    invitedAt: '2025-03-16T10:20:00.000Z',
    status: 'accepted',
    acceptedAt: '2025-03-17T07:45:00.000Z',
...
const buildSeedCoordinators = (): PrototypeDatabase['coordinators'] => [
  ...
  {
    id: 'coordinator-digital-uk',
    programId: 'program-uk-digital-2025',
    userId: 'partner-user-unicef-coordination',
    country: 'UK',
    region: 'Manchester',
    email: 'digital.uk@unicef.org',
    firstName: 'Sophie',
    lastName: 'Reid',
    phoneNumber: '+44 161 000 2233',
    status: 'active',
    invitedBy: 'partner-user-unicef-coordination',
    invitedAt: '2025-03-16T09:45:00.000Z',
    acceptedAt: '2025-03-16T11:00:00.000Z',
    createdAt: '2025-03-16T09:45:00.000Z',
    updatedAt: '2025-03-25T08:30:00.000Z',
  },
  {
    id: 'coordinator-digital-italy',
    programId: 'program-uk-digital-2025',
    userId: 'partner-user-almbrand-sponsor',
    country: 'IT',
    region: 'Lombardia',
    email: 'digital.it@almbrand.dk',
    firstName: 'Giulia',
    lastName: 'Rossi',
    phoneNumber: '+39 02 1234 7788',
    status: 'invited',
    invitedBy: 'partner-user-unicef-coordination',
    invitedAt: '2025-03-20T10:20:00.000Z',
    createdAt: '2025-03-20T10:20:00.000Z',
    updatedAt: '2025-03-25T07:50:00.000Z',
  },
]
