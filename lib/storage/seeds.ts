...
const buildSeedPrograms = (): PrototypeDatabase['programs'] => [
  {
    ...
    brandColor: '#F0B90B',
    logo: '/programs/build-the-change/logo.png',
    status: 'active',
    isPublic: true,
  ...
  },
  {
    ...
    brandColor: '#5B8DEF',
    logo: '/programs/communities-in-focus/logo.png',
    status: 'active',
    isPublic: true,
...
const buildSeedProjects = (): PrototypeDatabase['programProjects'] => [
  ...
  {
    id: 'program-project-communities-story',
    programId: 'program-communities-2025',
    projectId: 'project-communities-story',
    templateId: 'template-communities-story-circle',
    createdByType: 'teacher',
